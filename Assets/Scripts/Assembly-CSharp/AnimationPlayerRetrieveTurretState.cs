...
public class AnimationPlayerRetrieveTurretState : PlayerAnimationState
{
	...
	private EPosture m_posture = EPosture.UpperBody;

	private Dictionary<EPosture, AnimData> m_animDataDict = new Dictionary<EPosture, AnimData>();

	public AnimationPlayerRetrieveTurretState()
	{
		ca5a2b345087379ea02ec4ca950356e9f = "PlayerRetrieveTurret";
		m_animDataDict.Add(EPosture.FullBody, new AnimData(0, "RetrieveTurretFull", MecanimAnimationID.ID_1st_RetrieveTurret, "bRetrieveTurretFull"));
		m_animDataDict.Add(EPosture.UpperBody, new AnimData(1, "RetrieveTurretUpper", MecanimAnimationID.ID_1st_RetrieveTurret, "bRetrieveTurretUpper"));
	}
