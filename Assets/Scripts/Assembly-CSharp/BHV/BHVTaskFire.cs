...
namespace BHV
{
	public class BHVTaskFire : BHVTask
	{
		...
		private BHVTaskParamFire c2227ddc7fcbe3fa329465d2fa8ffb479;
		...
		private AnimationFireState c08664e2498d77e0ffdb744e33c663305;

		public BHVTaskFire()
		{
			base.m_Type = BHVTaskType.Fire;
			base.m_Layer = BHVTaskLayer.TOPBODY;
		}

		public override bool cd6c2cd7bb7b266ba7083ce848641dd61(BHVTaskParam cdbade0534e8f60b8dbad77a5270d9acf)
		{
			c2227ddc7fcbe3fa329465d2fa8ffb479 = cdbade0534e8f60b8dbad77a5270d9acf as BHVTaskParamFire;
		...
		public override void Start()
		{
			...
			c08664e2498d77e0ffdb744e33c663305 = cfc241af7ab51814fc074e767be1a0bb8.m_animationManagerFSM.c059bb29245b8e57e3b793798ddfdb249(Utils.ccafcaf40248e9bbb1784d38d8b267eae(AnimationStateFSM.Fire)) as AnimationFireState;
		}
		...
		public override void Update(float deltaTime)
		{
			...
			if (cfc241af7ab51814fc074e767be1a0bb8.m_entity == c9ac9b51d84401f2963498ec9c44725f0.c7088de59e49f7108f520cf7e0bae167e)
			{
				while (true)
				{
					...
					default:
						...
						DebugUtils.ccb67deef6e071a99e91295f0b4aacc89(LogCategory.AI, "m_BHVTaskManager.m_entity is null");
						return;
					}
				}
			}
			if (cfc241af7ab51814fc074e767be1a0bb8.m_entity.cdcf5e0592c05a681a8470f66674efd0b() == c9ac9b51d84401f2963498ec9c44725f0.c7088de59e49f7108f520cf7e0bae167e)
			{
				while (true)
				{
					...
					case 0:
						break;
					default:
						DebugUtils.ccb67deef6e071a99e91295f0b4aacc89(LogCategory.AI, "m_BHVTaskManager.m_entity.GetAIInventory() is null");
						return;
					}
				}
			}
			if (cfc241af7ab51814fc074e767be1a0bb8.m_animationManagerFSM == c9ac9b51d84401f2963498ec9c44725f0.c7088de59e49f7108f520cf7e0bae167e)
			{
				while (true)
				{
					...
					case 0:
						break;
					default:
						DebugUtils.ccb67deef6e071a99e91295f0b4aacc89(LogCategory.AI, "mm_BHVTaskManager.m_animationManagerFSM is null");
						return;
					}
				}
			}
			if (cfc241af7ab51814fc074e767be1a0bb8.m_animationManagerFSM.m_animationEventController == c9ac9b51d84401f2963498ec9c44725f0.c7088de59e49f7108f520cf7e0bae167e)
			{
				while (true)
				{
					...
					case 0:
						break;
					default:
						DebugUtils.ccb67deef6e071a99e91295f0b4aacc89(LogCategory.AI, "m_BHVTaskManager.m_animationManagerFSM.m_animationEventController is null");
						return;
					}
				}
			}
			...
			case FireState.c31cc7099a08a06274cd493826b095347:
			{
				...
				cfc241af7ab51814fc074e767be1a0bb8.m_animationManagerFSM.c04434b88d73eff2d8d910a75dbc1c5f2(AnimationStateFSM.Fire);
			...
			case FireState.c1d3e2cf1545b9321547e6a21bb58bfb3:
				...
				switch (cfc241af7ab51814fc074e767be1a0bb8.m_animationManagerFSM.c388d41f72ca44e2a282caa5bc1558d3c(AnimationStateFSM.Fire))
				{
