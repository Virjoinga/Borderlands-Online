...
public class AnimationPlayerRetrieveDroidState : PlayerAnimationState
{
	...
	public AnimationPlayerRetrieveDroidState()
	{
		ca5a2b345087379ea02ec4ca950356e9f = "PlayerRetrieveDroid";
		m_animDataDict.Add(EPosture.FullBody, new AnimData(0, "RetrieveDroidFull", MecanimAnimationID.ID_1st_RetrieveDroid, "bRetrieveDroidFull"));
		m_animDataDict.Add(EPosture.UpperBody, new AnimData(1, "RetrieveDroidUpper", MecanimAnimationID.ID_1st_RetrieveDroid, "bRetrieveDroidUpper"));
	}
