...
public class AnimationPlayerMoveState : PlayerAnimationState
{
	...
	public AnimationPlayerMoveState()
	{
		ca5a2b345087379ea02ec4ca950356e9f = "PlayerMove";
	}
	...
	public override void c07b7ce37423e253b784029efb12b608f()
	{
		...
		while (true)
		{
			...
			c4363c9ee832d0d0155375ca61d99d853("fDirection", moveDirection);
			...
			while (true)
			{
				...
				if (m_moveSpeed > 0.5f)
				{
					...
					ce7563fcf3b106cefb47b52f00fced07b(MecanimAnimationID.ID_1st_Sprint);
				}
				else
				{
					ce7563fcf3b106cefb47b52f00fced07b(MecanimAnimationID.ID_1st_StandMove);
				}
				float @float = m_firstPersonAnimator.GetFloat("fDirection");
				moveDirection = Mathf.Lerp(@float, moveDirection, 0.4f);
