...
public class AnimationCoverReloadState : AnimationManagerState
{
	private const string COVERRELOAD_TAG = "CoverReload";
	...
	public override void cdd79e3fb9f04672a139ad58f6b3176f7()
	{
		...
		if ((bool)m_AnimationManagerFSM.ccaaf181e61e5f9e050ba82237ed111a2)
		{
			...
			m_AnimationManagerFSM.ccaaf181e61e5f9e050ba82237ed111a2.SetInteger("CrouchStatus", 1);
				...
				while (true)
				{
					...
					default:
						if (!c4d656ad63e3960e094afed8e06b599f1(m_animatorInfo, m_startTime, 0.98f))
						{
							...
							if (m_animatorInfo.IsTag("CoverReload"))
							{
								return;
							}
							while (true)
