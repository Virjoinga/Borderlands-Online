...
public class uniPvPTipsView : PvPTipsView
{
	private class PvPTipsPanel : c196099a1254db61d3be10d70e14e7422
	{
			...
			if (mc_root == null)
			{
				while (true)
				{
					...
					default:
						...
						DebugUtils.ce93ff017745857c486c984051026749f(LogCategory.GUI, "UIWarning: PvPTipsPanel onInit() 'mc_root' is null! PvPTipsPanel won't work!!!");
						return;
					}
				}
			}
		...
		protected void c0159867dc6869bb2ec205ab748ad6afb()
		{
			...
			m_Timer.Start(180f);
			tf_Content.text = LobbyManager.c71f6ce28731edfd43c976fbd57c57bea().c21e3fb25e984c496cedc0a63b1159b2b() + LocalizedString.c00ae05b9ced94c9fc5f4be4892e6192b(new LocalizedString("PVP_MatchMaking_Invitation"));
		...
		{
			LobbyManager.c71f6ce28731edfd43c976fbd57c57bea().m_bCanShowMessage = true;
		...
		{
			m_Timer.cdada4c3678c9c23c38aaf0754a94a620();
			LobbyManager.c71f6ce28731edfd43c976fbd57c57bea().c56f2ef09c2c7b78d464a6d3be6b30e33();
		}

		private void ca33994444ab1c48d7a328fa41683bcc1(CEvent c145c47696cdb7404f93dd0c2b26cfd51)
		{
			m_Timer.cdada4c3678c9c23c38aaf0754a94a620();
			LobbyManager.c71f6ce28731edfd43c976fbd57c57bea().cb29008727fccd108206478ea0a634586();
		}
	...
	private PvPTipsPanel _tipsPanel;

	public override void cd93285db16841148ed53a5bbeb35cf20()
	{
		base.cd93285db16841148ed53a5bbeb35cf20();
		(c06ca0e618478c23eba3419653a19760f<AppManager>.c5ee19dc8d4cccf5ae2de225410458b86.cad4d42df23ad826d4b65d44d510c01a3() as UniUIManager).c9a36e6e68967bc69944e0eaf2aa68d73("pvp_match_making.swf", "Mc_tips", c9146a59b9c150cdd9c09812ac728cfc1);
	}

	public override void cac7688b05e921e2be3f92479ba44b4a8()
	{
		base.cac7688b05e921e2be3f92479ba44b4a8();
		(c06ca0e618478c23eba3419653a19760f<AppManager>.c5ee19dc8d4cccf5ae2de225410458b86.cad4d42df23ad826d4b65d44d510c01a3() as UniUIManager).c27542a6dc8f97862ef53db1d4f3a6db8(_tipsPanel);
		_tipsPanel = null;
	...
	private void c9146a59b9c150cdd9c09812ac728cfc1(MovieClip cbe9ca8ddb3cdc2312e6ff8411b2db2c8)
	{
		_tipsPanel = new PvPTipsPanel();
		_tipsPanel.c130648b59a0c8debea60aa153f844879(cbe9ca8ddb3cdc2312e6ff8411b2db2c8);
		_tipsPanel.c150264a18c2cb408479d3f072cac8cc1 = false;
	}
	...
	protected override void cbf5f806ecf4d92b475f68040522616cf(bool c8be1fcd630e5fe96821376d111325750, bool c9e82bede03ea180ba65a597350997ad2 = false)
	{
		...
		if (c8be1fcd630e5fe96821376d111325750)
		{
			...
			(c06ca0e618478c23eba3419653a19760f<AppManager>.c5ee19dc8d4cccf5ae2de225410458b86.cad4d42df23ad826d4b65d44d510c01a3() as UniUIManager).c120a0ab44e69ef682f36041c0b116750(_tipsPanel);
		}
		else
		{
			(c06ca0e618478c23eba3419653a19760f<AppManager>.c5ee19dc8d4cccf5ae2de225410458b86.cad4d42df23ad826d4b65d44d510c01a3() as UniUIManager).c27542a6dc8f97862ef53db1d4f3a6db8(_tipsPanel);
		}
		_tipsPanel.c150264a18c2cb408479d3f072cac8cc1 = c8be1fcd630e5fe96821376d111325750;
	}
}
