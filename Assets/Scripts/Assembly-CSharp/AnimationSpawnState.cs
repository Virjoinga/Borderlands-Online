...
public class AnimationSpawnState : AnimationManagerState
{
	private const string SPAWN_TAG = "Spawn";

	public bool m_spawnStarted;
	...
	public override void cdd79e3fb9f04672a139ad58f6b3176f7()
	{
		...
		m_AnimationManagerFSM.ccaaf181e61e5f9e050ba82237ed111a2.SetBool("IsSpawn", true);
		if ((bool)m_VFXManager)
		{
			...
			m_VFXManager.cabda1e77309d61d99a04e4b57b962f2f(ENPCParticleType.E_Spawn);
		}
	...
	public override void caeee91e34d54e1e41ab1b380f7d8c9a4()
	{
		...
		m_AnimationManagerFSM.ccaaf181e61e5f9e050ba82237ed111a2.SetBool("IsSpawn", false);
		if ((bool)m_VFXManager)
		{
			while (true)
			{
			...
			m_VFXManager.c61965fdbaf3e5bcda81d0af5a65e1ac8(ENPCParticleType.E_Spawn);
		}
