...
namespace A
{
	public class cb870df68606561cd5d8d0566ef0cdfea : c9f62278a5e2341872ad7373d9bb65f26
	{
		...
		protected override void c969016383f47c249932cc75475f00ae1()
		{
			...
			c29ac24d0dfbf9258ca8c8da7869f10b3.text = LocalizedString.c00ae05b9ced94c9fc5f4be4892e6192b(new LocalizedString("Group_Invitation"));
		...
		protected override void c39fc9de70a274455503ae86287e8d293()
		{
			...
			if (!GroupManager.c71f6ce28731edfd43c976fbd57c57bea().c7c5f912483194aee7c558f9a8f924590(c93b9f9e7db3254d97a5118f2dcffe924))
			{
				while (true)
				{
					switch (2)
			...
			if (GroupManager.c71f6ce28731edfd43c976fbd57c57bea().cd32f7e7341db49df05a3ff0c78164577(c93b9f9e7db3254d97a5118f2dcffe924) == GroupManager.InviteMessageStatus.e_WaitingForDecide)
			{
				while (true)
				{
					switch (3)
			...
			switch (GroupManager.c71f6ce28731edfd43c976fbd57c57bea().cd32f7e7341db49df05a3ff0c78164577(c93b9f9e7db3254d97a5118f2dcffe924))
			{
			case GroupManager.InviteMessageStatus.e_Accepted:
				cfacada943602304f57c27f8805d8874e.text = LocalizedString.c00ae05b9ced94c9fc5f4be4892e6192b(new LocalizedString("Accepted"));
				break;
			case GroupManager.InviteMessageStatus.e_Rejected:
				cfacada943602304f57c27f8805d8874e.text = LocalizedString.c00ae05b9ced94c9fc5f4be4892e6192b(new LocalizedString("Rejected"));
				break;
			case GroupManager.InviteMessageStatus.e_Decided:
				cfacada943602304f57c27f8805d8874e.text = LocalizedString.c00ae05b9ced94c9fc5f4be4892e6192b(new LocalizedString("Waiting_For_Join"));
				break;
			case GroupManager.InviteMessageStatus.e_Locked:
				cfacada943602304f57c27f8805d8874e.text = LocalizedString.c00ae05b9ced94c9fc5f4be4892e6192b(new LocalizedString("Waiting"));
				break;
			case GroupManager.InviteMessageStatus.e_JoinFailed:
				cfacada943602304f57c27f8805d8874e.text = LocalizedString.c00ae05b9ced94c9fc5f4be4892e6192b(new LocalizedString("Can't_Join"));
				break;
			default:
				cfacada943602304f57c27f8805d8874e.text = string.Empty;
				break;
			}
		}
		...
		{
			if (!cf25ef84246e4fadefec44ad7b5af2705.cbf402c82d0fffee7c8f37c98e456b8f8)
			{
				while (true)
				{
					switch (6)
			...
			if (!c47b7e7a3442c5865120ab095cac1a87a.cbf402c82d0fffee7c8f37c98e456b8f8)
			{
				while (true)
				{
					switch (3)
				...
				c47b7e7a3442c5865120ab095cac1a87a.cbf402c82d0fffee7c8f37c98e456b8f8 = true;
			}
		...
		{
			GroupManager.c71f6ce28731edfd43c976fbd57c57bea().cdbf6ca3febfb43b0ac5385a805224dba(c93b9f9e7db3254d97a5118f2dcffe924);
		}

		protected void c057d6e1ceab016fc023618c40b64ee9d(CEvent c3d202dee321219a80026dc3081fb3c86)
		{
			GroupManager.c71f6ce28731edfd43c976fbd57c57bea().cdfec21f23b7b4cb0a9ca48d4fa122044(c93b9f9e7db3254d97a5118f2dcffe924);
		}

		public override void c263a18e823d534fe933bf797fd17c221(int c62a53388af21c9e5e206591a30eb9f80)
		{
			PlayerProperties playerProperties = GroupManager.c71f6ce28731edfd43c976fbd57c57bea().cf27a45b19d5e6ff6e43fa1bead37845d(c62a53388af21c9e5e206591a30eb9f80);
			...
			while (true)
			{
				...
				c029b121c24c5be9b10e59bcb9fccd983.gotoAndStop(playerProperties.m_avatarDna.c071244a19e2d9f70f4d2d6d38677162a().ToString());
				cab8907a76c736cb687705dd983f067f3.gotoAndStop(playerProperties.m_avatarDna.c071244a19e2d9f70f4d2d6d38677162a().ToString());
				return;
			}
		}
	}
