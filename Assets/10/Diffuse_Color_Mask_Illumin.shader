‡šShader "Shader Forge/Diffuse_Color_Mask_Illumin" {
Properties {
 ...
 _Illumin_Color ("Illumin_Color", Color) = (1,0.765517,0,1)
 _Illumin ("Illumin", Float) = 5
}
SubShader { 
...
MAD R1.xyz, R0, R2, R1;
MUL R0.x, R4, c[8];
MAD result.color.xyz, R0.x, c[7], R1;
...
dcl_2d s1
dcl_2d s2
def c8, 2.00000000, 0.50000000, 1.00000000, 0
dcl_texcoord0 v0.xy
dcl_texcoord5 v3
...
add_pp r1.xyz, -r1, c0
mul r0.w, r0.x, c5.x
mul_pp r0.xyz, r1, c8.y
mul_pp r2.xyz, r2, c8.x
add r0.xyz, r0, v4
mul r1.xyz, r2, r0.w
mad r1.xyz, r0, r3, r1
mul r0.x, r4, c7
mad oC0.xyz, r0.x, c6, r1
mov_pp oC0.w, c8.z
"
}
SubProgram "d3d11 " {
...
BindCB  "$Globals" 0
"ps_4_0
eefiecedonhgonlbgbhjimpmkhagpnbpgdfejmccabaaaaaamaaeaaaaadaaaaaa
...

...

...
dcl_2d s3
dcl_2d s4
def c8, 8.00000000, 2.00000000, 1.00000000, 0
dcl_texcoord0 v0.xy
dcl_texcoord5 v3
dcl_texcoord6 v4.xy
dcl_texcoord7 v5
...
BindCB  "$Globals" 0
"ps_4_0
eefiecedaedmlagedgkcnefkdnkobeejpmgnefhaabaaaaaaaiagaaaaadaaaaaa
...
feeffiedepepfceeaaklklklepfdeheocmaaaaaaabaaaaaaaiaaaaaacaaaaaaa
aaaaaaaaaaaaaaaaadaaaaaaaaaaaaaaapaaaaaafdfgfpfegbhcghgfheaaklkl
fdeieefckaaeaaaaeaaaaaaaciabaaaafjaaaaaeegiocaaaaaaaaaaaamaaaaaa
...
acaaaaaaakiacaaaaaaaaaaaajaaaaaadiaaaaaiicaabaaaabaaaaaaakaabaaa
acaaaaaaakiacaaaaaaaaaaaalaaaaaadcaaaaaldcaabaaaacaaaaaaegbabaaa
...
abaaaaaadcaaaaajhcaabaaaaaaaaaaaegacbaaaaaaaaaaajgahbaaaacaaaaaa
egacbaaaabaaaaaadcaaaaakhccabaaaaaaaaaaapgapbaaaabaaaaaaegiccaaa
aaaaaaaaakaaaaaaegacbaaaaaaaaaaadgaaaaaficcabaaaaaaaaaaaabeaaaaa
aaaaiadpdoaaaaab"
}
SubProgram "opengl " {
Keywords { "LIGHTMAP_ON" "DIRLIGHTMAP_ON" "HDR_LIGHT_PREPASS_OFF" }
...
dcl_2d s3
dcl_2d s4
def c8, 8.00000000, 0.57735026, -0.40824831, 0.70710677
def c9, 0.81649655, 0.00000000, 0.57735026, 64.00000000
def c10, -0.40824828, -0.70710677, 0.57735026, 2.00000000
...
mul r0.xyz, r1.y, c8.zwyw
mad r0.xyz, r1.x, c9, r0
mad r0.xyz, r1.z, c10, r0
dp3 r0.w, r0, r0
rsq r0.w, r0.w
mul r4.xyz, r0.w, r0
...
BindCB  "UnityPerCamera" 1
"ps_4_0
eefiecedeficpfbopdihaohaoekhbdgppphjapgoabaaaaaaaeajaaaaadaaaaaa
cmaaaaaabeabaaaaeiabaaaaejfdeheooaaaaaaaaiaaaaaaaiaaaaaamiaaaaaa
aaaaaaaaabaaaaaaadaaaaaaaaaaaaaaapaaaaaaneaaaaaaaaaaaaaaaaaaaaaa
...
epfdejfeejepeoaafeeffiedepepfceeaaklklklepfdeheocmaaaaaaabaaaaaa
aiaaaaaacaaaaaaaaaaaaaaaaaaaaaaaadaaaaaaaaaaaaaaapaaaaaafdfgfpfe
gbhcghgfheaaklklfdeieefcleahaaaaeaaaaaaaonabaaaafjaaaaaeegiocaaa
...

doaaaaab"
}
SubProgram "opengl " {
Keywords { "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "HDR_LIGHT_PREPASS_ON" }
...
BindCB  "$Globals" 0
"ps_4_0

...

...

...
acaaaaaaeghobaaaacaaaaaaaagabaaaacaaaaaadiaaaaaiicaabaaaaaaaaaaa
ckaabaaaacaaaaaaakiacaaaaaaaaaaaahaaaaaadiaaaaaiicaabaaaabaaaaaa
akaabaaaacaaaaaaakiacaaaaaaaaaaaajaaaaaadcaaaaaldcaabaaaacaaaaaa
...

...
BindCB  "$Globals" 0
"ps_4_0

...

...
aaaaaaaackaabaaaacaaaaaaakiacaaaaaaaaaaaajaaaaaadiaaaaaiicaabaaa
abaaaaaaakaabaaaacaaaaaaakiacaaaaaaaaaaaalaaaaaadcaaaaaldcaabaaa
...
jgahbaaaacaaaaaaegacbaaaabaaaaaadcaaaaakhccabaaaaaaaaaaapgapbaaa
abaaaaaaegiccaaaaaaaaaaaakaaaaaaegacbaaaaaaaaaaadgaaaaaficcabaaa
...
BindCB  "UnityPerCamera" 1
"ps_4_0

...
kgakbaaaaaaaaaaaegacbaaaacaaaaaaaaaaaaajhcaabaaaacaaaaaaegacbaia
ebaaaaaaadaaaaaaegiccaaaaaaaaaaaagaaaaaadcaaaaaldcaabaaaaeaaaaaa
...

abeaaaaaaaaaiadpdoaaaaab"
}
}
 }
...
BindCB  "UnityPerDraw" 0
"vs_4_0
eefiecedlcbljchppklhenjggnhipmmnmddlopjpabaaaaaaieafaaaaadaaaaaa
...
aaaaaaaaadaaaaaaagaaaaaaahapaaaafdfgfpfaepfdejfeejepeoaafeeffied
epepfceeaaklklklfdeieefcneadaaaaeaaaabaapfaaaaaafjaaaaaeegiocaaa
...

...
BindCB  "UnityPerDraw" 1
"vs_4_0

...
ahaaaaaaahapaaaafdfgfpfaepfdejfeejepeoaafeeffiedepepfceeaaklklkl
fdeieefchmaeaaaaeaaaabaabpabaaaafjaaaaaeegiocaaaaaaaaaaaagaaaaaa
...
pccabaaaacaaaaaagfaaaaadhccabaaaadaaaaaagfaaaaadhccabaaaaeaaaaaa
gfaaaaadhccabaaaafaaaaaagfaaaaadpccabaaaagaaaaaagiaaaaacaeaaaaaa
...
kgbkbaaaaaaaaaaaegaobaaaabaaaaaadcaaaaakpccabaaaacaaaaaaegiocaaa
abaaaaaaapaaaaaapgbpbaaaaaaaaaaaegaobaaaabaaaaaabaaaaaaibcaabaaa
...
abaaaaaaegbcbaaaabaaaaaaegiccaaaabaaaaaabcaaaaaadgaaaaafhccabaaa
adaaaaaaegacbaaaabaaaaaadiaaaaaihcaabaaaacaaaaaafgbfbaaaacaaaaaa
...
MAX R0.w, R0, c[10].x;
MUL R1.w, R0.x, c[7].x;
POW R0.w, R0.w, c[10].y;
MUL R0.w, R0, R1;
MUL R3.xyz, R0.w, c[2];
DP3 R0.w, R1, R2;
MAD R1.xy, fragment.texcoord[0], c[5], c[5].zwzw;
TEX R2.xz, R1, texture[0], 2D;
ADD R1.xyz, -R0, c[3];
MUL R1.w, R2.z, c[6].x;
...
MAD R1.xyz, R0, R1, R3;
MUL R0.x, R2, c[9];
MAD result.color.xyz, R0.x, c[8], R1;
...
dcl_2d s0
dcl_2d s1
def c10, 0.00000000, 64.00000000, 1.00000000, 0
dcl_texcoord0 v0.xy
dcl_texcoord1 v1.xyz
dcl_texcoord2 v2.xyz
...
"ps_4_0
eefiecedcocfegfbimfbaneblinkelhnkmigfjbaabaaaaaaaiagaaaaadaaaaaa
...
eghobaaaabaaaaaaaagabaaaaaaaaaaadiaaaaaiicaabaaaabaaaaaaakaabaaa
...

aaaaiadpdoaaaaab"
}
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "SHADOWS_OFF" "LIGHTMAP_ON" "DIRLIGHTMAP_OFF" }
...
TEX R4.xz, R3, texture[1], 2D;
MAX R0.x, R0, c[10].y;
MUL R0.y, R1.x, c[7].x;
POW R0.x, R0.x, c[10].z;
MUL R0.x, R0, R0.y;
MUL R2.xyz, R0.x, c[2];
...
dcl_2d s1
dcl_2d s2
def c10, 8.00000000, 0.00000000, 64.00000000, 1.00000000
dcl_texcoord0 v0.xy
dcl_texcoord1 v1.xyz
dcl_texcoord2 v2.xyz
dcl_texcoord7 v3.xy
...
BindCB  "UnityLighting" 2
"ps_4_0
eefieceddgfpkgcpkmhkmdakejgondkdpbeijjmcabaaaaaadaagaaaaadaaaaaa
cmaaaaaapmaaaaaadaabaaaaejfdeheomiaaaaaaahaaaaaaaiaaaaaalaaaaaaa
aaaaaaaaabaaaaaaadaaaaaaaaaaaaaaapaaaaaalmaaaaaaaaaaaaaaaaaaaaaa
...
giaaaaacafaaaaaabaaaaaajbcaabaaaaaaaaaaaegiccaaaacaaaaaaaaaaaaaa
...
abaaaaaajgafbaaaaaaaaaaaeghobaaaacaaaaaaaagabaaaabaaaaaadiaaaaai
...

...
RSQ R0.w, R0.w;
MUL R4.xyz, R0.w, R1;
MUL R1.xyz, R4.y, fragment.texcoord[4];
MAD R3.xyz, R4.x, fragment.texcoord[3], R1;
DP3 R0.w, fragment.texcoord[2], fragment.texcoord[2];
RSQ R1.w, R0.w;
MUL R2.xyz, R1.w, fragment.texcoord[2];
ADD R1.xyz, -fragment.texcoord[1], c[0];
DP3 R0.w, R1, R1;
MAD R3.xyz, R4.z, R2, R3;
RSQ R0.w, R0.w;
...
TEX R1, fragment.texcoord[7], texture[0], 2D;
MUL R1.xyz, R1.w, R1;
DP3 R1.w, R0, c[8].y;
MUL R0.xyz, R1, c[8].x;
MAD R1.xy, fragment.texcoord[0], c[3], c[3].zwzw;
TEX R4.xz, R1, texture[2], 2D;
MAX R0.w, R0, c[8].z;
MUL R0.xyz, R0, R1.w;
POW R0.w, R0.w, c[8].w;
MUL R2.w, R2.x, c[5].x;
...
dcl_2d s2
dcl_2d s3
def c8, 8.00000000, 0.57714844, 0.00000000, 64.00000000
...
BindCB  "UnityPerCamera" 1
"ps_4_0

...
efaaaaajpcaabaaaabaaaaaaogakbaaaaaaaaaaaeghobaaaadaaaaaaaagabaaa
...

aaaaaaaaabeaaaaaaaaaiadpdoaaaaab"
}
SubProgram "opengl " {
...
TEMP R5;
ADD R0.xyz, -fragment.texcoord[1], c[0];
TXP R2.x, fragment.texcoord[5], texture[0], 2D;
DP3 R0.w, c[1], c[1];
RSQ R0.w, R0.w;
DP3 R1.x, R0, R0;
MUL R5.xyz, R0.w, c[1];
...
RSQ R0.w, R0.w;
MUL R0.xyz, R1.x, R0;
MUL R2.yzw, R0.w, fragment.texcoord[2].xxyz;
DP3 R0.x, R2.yzww, R0;
MAX R0.z, R0.x, c[10].x;
POW R0.w, R0.z, c[10].y;
...
MUL R2.xyz, R2.x, c[2];
MAX R0.w, R0, c[10].x;
MAD R2.xyz, R0.w, R2, fragment.texcoord[7];
MAD R2.xyz, R2, R0, R4;
MUL R0.x, R1, c[9];
MAD result.color.xyz, R0.x, c[8], R2;
MOV result.color.w, c[10].z;
END
...
mul r3.xyz, r2.x, c2
max r0.w, r0, c10.x
mad r3.xyz, r0.w, r3, v4
mad r2.xyz, r3, r0, r2.yzww
mul r0.x, r1, c9
mad oC0.xyz, r0.x, c8, r2
mov_pp oC0.w, c10.z
"
}
SubProgram "d3d11 " {
...
BindCB  "UnityLighting" 2
"ps_4_0

...
epfdejfeejepeoaafeeffiedepepfceeaaklklklepfdeheocmaaaaaaabaaaaaa
aiaaaaaacaaaaaaaaaaaaaaaaaaaaaaaadaaaaaaaaaaaaaaapaaaaaafdfgfpfe
gbhcghgfheaaklklfdeieefcieafaaaaeaaaaaaagbabaaaafjaaaaaeegiocaaa
...
aiaaaaaaefaaaaajpcaabaaaabaaaaaaogakbaaaaaaaaaaaeghobaaaacaaaaaa
...
hcaabaaaaaaaaaaajgahbaaaaaaaaaaaagaabaaaaaaaaaaaaaaaaaajhcaabaaa
adaaaaaaegacbaiaebaaaaaaabaaaaaaegiccaaaaaaaaaaaahaaaaaadcaaaaal
...

...
BindCB  "UnityLighting" 2
"ps_4_0
eefiecedaggikpjbbccgoljnlmmkkfngfoegmnbfabaaaaaaoaagaaaaadaaaaaa
cmaaaaaabeabaaaaeiabaaaaejfdeheooaaaaaaaaiaaaaaaaiaaaaaamiaaaaaa
aaaaaaaaabaaaaaaadaaaaaaaaaaaaaaapaaaaaaneaaaaaaaaaaaaaaaaaaaaaa
...
abaaaaaajgafbaaaaaaaaaaaeghobaaaadaaaaaaaagabaaaacaaaaaadiaaaaai
...

...
dcaaaaakhccabaaaaaaaaaaapgapbaaaabaaaaaaegiccaaaaaaaaaaaamaaaaaa
egacbaaaaaaaaaaadgaaaaaficcabaaaaaaaaaaaabeaaaaaaaaaiadpdoaaaaab
"
}
SubProgram "opengl " {
...
DP3 R0.w, R1, R2;
MAD R1.xy, fragment.texcoord[0], c[2], c[2].zwzw;
TEX R2.xyz, R1, texture[4], 2D;
TEX R1, fragment.texcoord[7], texture[0], 2D;
MUL R1.xyz, R1.w, R1;
DP3 R1.w, R0, c[8].y;
MUL R0.xyz, R1, c[8].x;
MAD R1.xy, fragment.texcoord[0], c[3], c[3].zwzw;
TEX R4.xz, R1, texture[3], 2D;
MAX R0.w, R0, c[8].z;
MUL R0.xyz, R0, R1.w;
POW R0.w, R0.w, c[8].w;
MUL R2.w, R2.x, c[5].x;
...
BindCB  "UnityPerCamera" 1
"ps_4_0

...

...
afaaaaaaefaaaaajpcaabaaaaaaaaaaaogbkbaaaabaaaaaaeghobaaaabaaaaaa
...
abaaaaaaogakbaaaaaaaaaaaeghobaaaadaaaaaaaagabaaaacaaaaaadiaaaaai
...

aaaaiadpdoaaaaab"
}
}
 }
