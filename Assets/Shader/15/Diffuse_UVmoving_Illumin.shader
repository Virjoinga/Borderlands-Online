¿ÚShader "Shader Forge/Diffuse_UVmoving_Illumin" {
Properties {
 _Diffuse ("Diffuse", 2D) = "white" {}
 _V_speed ("V_speed", Float) = 1
 _Illumin_Color ("Illumin_Color", Color) = (1,0.869081,0,1)
 _Illumin ("Illumin", Float) = 3
 _Mask ("Mask", 2D) = "white" {}
 _U_speed ("U_speed", Float) = -1
 _UV_Change ("UV_Change", Float) = 1
}
SubShader { 
...
"vs_4_0
eefiecedmjehgppojdkfpmekmoekhngdgobipolhabaaaaaabiaiaaaaadaaaaaa
...
eaaaabaaioabaaaafjaaaaaeegiocaaaaaaaaaaaagaaaaaafjaaaaaeegiocaaa
...
aaaaaaaaafaaaaaakgiocaaaaaaaaaaaafaaaaaadgaaaaafdccabaaaabaaaaaa
...
TEMP R2;
TEMP R3;
TXP R2.xyz, fragment.texcoord[5], texture[0], 2D;
MOV R0.x, c[1].y;
ADD R0.x, R0, c[0].y;
MUL R0.y, R0.x, c[7].x;
MOV R3.xyz, c[4];
MAD R0.zw, R0.y, c[9].xyzy, fragment.texcoord[0].xyxy;
MUL R0.x, R0, c[3];
MAD R0.xy, R0.x, c[9].yzzw, fragment.texcoord[0];
ADD R0.xy, R0, -R0.zwzw;
MAD R0.xy, R0, c[8].x, R0.zwzw;
MAD R0.xy, R0, c[6], c[6].zwzw;
MAD R0.zw, fragment.texcoord[0].xyxy, c[2].xyxy, c[2];
TEX R1.xyz, R0.zwzw, texture[1], 2D;
TEX R0.y, R0, texture[2], 2D;
MUL R3.xyz, R3, c[5].x;
MAD R0.yzw, R0.y, R3.xxyz, -R1.xxyz;
...
dcl_2d s1
dcl_2d s2
def c9, 0.50000000, 0.00000000, 1.00000000, 0
dcl_texcoord0 v0.xy
dcl_texcoord5 v2
...
mad r0.zw, r0.y, c9.xyzy, v0.xyxy
mul r0.x, r0, c3
mad r0.xy, r0.x, c9.yzzw, v0
add r0.xy, r0, -r0.zwzw
mad r0.xy, r0, c8.x, r0.zwzw
...
Float 96 [_V_speed]
Vector 112 [_Illumin_Color]
Float 128 [_Illumin]
Vector 144 [_Mask_ST]
Float 160 [_U_speed]
Float 164 [_UV_Change]
ConstBuffer "UnityPerCamera" 128
Vector 0 [_Time]
BindCB  "$Globals" 0
BindCB  "UnityPerCamera" 1
"ps_4_0
eefiecedmgimghajhjljjefhflbanllhbbeboakmabaaaaaadaafaaaaadaaaaaa
...

...
eghobaaaaaaaaaaaaagabaaaaaaaaaaacpaaaaafhcaabaaaacaaaaaaegacbaaa
acaaaaaadcaaaaamhcaabaaaacaaaaaaegacbaaaacaaaaaaaceaaaaaaaaaaalp
aaaaaalpaaaaaalpaaaaaaaaegbcbaaaahaaaaaadcaaaaajhccabaaaaaaaaaaa
...
MUL R0.y, R0.x, c[8].x;
MOV R1.xyz, c[5];
MAD R0.zw, R0.y, c[10].xyzy, fragment.texcoord[0].xyxy;
MUL R0.x, R0, c[4];
MAD R0.xy, R0.x, c[10].yzzw, fragment.texcoord[0];
ADD R0.xy, R0, -R0.zwzw;
MAD R0.xy, R0, c[9].x, R0.zwzw;
MAD R0.xy, R0, c[7], c[7].zwzw;
MAD R0.zw, fragment.texcoord[0].xyxy, c[3].xyxy, c[3];
TEX R2.xyz, R0.zwzw, texture[3], 2D;
TEX R0.y, R0, texture[4], 2D;
...
dcl_2d s3
dcl_2d s4
def c10, 8.00000000, 0.00000000, 1.00000000, 0
dcl_texcoord0 v0.xy
dcl_texcoord5 v2
dcl_texcoord6 v3.xy
dcl_texcoord7 v4
...
mad r0.zw, r0.y, c10.xyzy, v0.xyxy
mul r0.x, r0, c4
mad r0.xy, r0.x, c10.yzzw, v0
add r0.xy, r0, -r0.zwzw
mad r0.xy, r0, c9.x, r0.zwzw
...
Vector 176 [_Mask_ST]
Float 192 [_U_speed]
Float 196 [_UV_Change]
ConstBuffer "UnityPerCamera" 128
Vector 0 [_Time]
BindCB  "$Globals" 0
BindCB  "UnityPerCamera" 1
"ps_4_0
eefiecedhgihidgcjajonipgmkljcelkiijjmblfabaaaaaamaagaaaaadaaaaaa
...
feeffiedepepfceeaaklklklepfdeheocmaaaaaaabaaaaaaaiaaaaaacaaaaaaa
aaaaaaaaaaaaaaaaadaaaaaaaaaaaaaaapaaaaaafdfgfpfegbhcghgfheaaklkl
fdeieefcfiafaaaaeaaaaaaafgabaaaafjaaaaaeegiocaaaaaaaaaaaanaaaaaa
...
dcbabaaaabaaaaaagcbaaaadmcbabaaaabaaaaaagcbaaaadlcbabaaaagaaaaaa
gcbaaaadpcbabaaaahaaaaaagfaaaaadpccabaaaaaaaaaaagiaaaaacaeaaaaaa
bbaaaaahbcaabaaaaaaaaaaaegbobaaaahaaaaaaegbobaaaahaaaaaaelaaaaaf
...

...
aagabaaaadaaaaaadcaaaaakhcaabaaaabaaaaaafgafbaaaabaaaaaaigadbaaa
abaaaaaaegacbaiaebaaaaaaacaaaaaadcaaaaaldcaabaaaadaaaaaaegbabaaa
...
dcaaaaajhcaabaaaabaaaaaaagaabaaaadaaaaaaegacbaaaabaaaaaaegacbaaa
...
TXP R0.xyz, fragment.texcoord[5], texture[0], 2D;
MUL R0.yzw, R0.xxyz, c[9].x;
MAD R3.xy, fragment.texcoord[0], c[6], c[6].zwzw;
TEX R0.x, R3, texture[2], 2D;
MAD R2.xyz, R0.x, R2, R1;
ADD R0.xyz, R0.yzww, fragment.texcoord[6];
...
mad r2.xyz, r0.y, r2, -r1
texldp r0.xyz, v2, s0
mul_pp r0.yzw, r0.xxyz, c9.x
mad r3.xy, v0, c6, c6.zwzw
texld r0.x, r3, s2
mad r2.xyz, r0.x, r2, r1
add r0.xyz, r0.yzww, v3
...
BindCB  "UnityPerCamera" 1
"ps_4_0

...
acaaaaaaaceaaaaaaaaaaadpaaaaaadpaaaaaadpaaaaaaaaegbcbaaaahaaaaaa
...
TEX R2, fragment.texcoord[6], texture[1], 2D;
MAD R0.xyz, R0.x, R3, R1;
MUL R3.xyz, R2.w, R2;
TEX R2, fragment.texcoord[6], texture[2], 2D;
MUL R2.xyz, R2.w, R2;
...
BindCB  "UnityPerCamera" 1
"ps_4_0

...

...

...

...
BindCB  "UnityPerDraw" 1
"vs_4_0

...
agiecaaaaaaaaaaaaeaaaaaakgiocaaaaaaaaaaaaeaaaaaadgaaaaafdccabaaa
...
BindCB  "UnityPerDraw" 2
"vs_4_0

...
fdeieefcnaaeaaaaeaaaabaadeabaaaafjaaaaaeegiocaaaaaaaaaaaajaaaaaa
...
Vector 3 [_TimeEditor]
Vector 4 [_Diffuse_ST]
Float 5 [_V_speed]
Vector 6 [_Illumin_Color]
Float 7 [_Illumin]
Vector 8 [_Mask_ST]
Float 9 [_U_speed]
Float 10 [_UV_Change]
...
MUL R0.y, R0.x, c[9].x;
MOV R2.xyz, c[6];
MAD R0.zw, R0.y, c[11].xyyx, fragment.texcoord[0].xyxy;
MUL R0.x, R0, c[5];
MAD R0.xy, R0.x, c[11], fragment.texcoord[0];
ADD R0.xy, R0, -R0.zwzw;
MAD R0.xy, R0, c[10].x, R0.zwzw;
MAD R0.xy, R0, c[8], c[8].zwzw;
...
MAD R2.xyz, R0.x, R3, R1;
MAX R0.z, R0, c[11].x;
MAD R0.xyz, R0.z, c[2], fragment.texcoord[7];
MAD result.color.xyz, R0, R1, R2;
...
mad r0.zw, r0.y, c11.xyyx, v0.xyxy
mul r0.x, r0, c5
mad r0.xy, r0.x, c11, v0
add r0.xy, r0, -r0.zwzw
...
"ps_4_0
eefiecedcjppfknbkambpeppigfbhokljlnhhjahabaaaaaaimafaaaaadaaaaaa
...
abaaaaaaffffaaaagcbaaaaddcbabaaaabaaaaaagcbaaaadhcbabaaaadaaaaaa
...
aaaaaaaaegbcbaaaadaaaaaabaaaaaajicaabaaaaaaaaaaaegiccaaaacaaaaaa
...

...

...
abaaaaaaaagabaaaabaaaaaadcaaaaajhcaabaaaabaaaaaaagaabaaaadaaaaaa
...
dcl_2d s1
dcl_2d s2
def c9, 8.00000000, 0.00000000, 1.00000000, 0
dcl_texcoord0 v0.xy
dcl_texcoord7 v2.xy
mov r0.x, c0.y
add r0.x, c1.y, r0
...
BindCB  "UnityPerCamera" 1
"ps_4_0
eefiecedjbmcmbdjcbfkbnpgkcfodpofkjgohjnlabaaaaaaoeaeaaaaadaaaaaa
cmaaaaaapmaaaaaadaabaaaaejfdeheomiaaaaaaahaaaaaaaiaaaaaalaaaaaaa
aaaaaaaaabaaaaaaadaaaaaaaaaaaaaaapaaaaaalmaaaaaaaaaaaaaaaaaaaaaa
...
cmaaaaaaabaaaaaaaiaaaaaacaaaaaaaaaaaaaaaaaaaaaaaadaaaaaaaaaaaaaa
apaaaaaafdfgfpfegbhcghgfheaaklklfdeieefckmadaaaaeaaaaaaaolaaaaaa
...

...
aagabaaaacaaaaaadcaaaaajhcaabaaaaaaaaaaaagaabaaaacaaaaaaegacbaaa
...
pgapbaaaaaaaaaaadcaaaaajhccabaaaaaaaaaaaegacbaaaacaaaaaaegacbaaa
...
MAD R0.yzw, R0.x, R2.xxyz, R1.xxyz;
DP3 R0.x, fragment.texcoord[2], fragment.texcoord[2];
RSQ R0.x, R0.x;
...
MUL R2.xyz, R0.x, c[2];
MAX R0.x, R1.w, c[11];
MAD R2.xyz, R0.x, R2, fragment.texcoord[7];
...
mul r2.xyz, r0.x, c2
max r0.x, r1.w, c11
mad r2.xyz, r0.x, r2, v3
mad oC0.xyz, r2, r1, r0.yzww
mov_pp oC0.w, c11.y
"
}
SubProgram "d3d11 " {
...
BindCB  "UnityLighting" 2
"ps_4_0

...
dcbabaaaabaaaaaagcbaaaadhcbabaaaadaaaaaagcbaaaadlcbabaaaagaaaaaa
...

...

aaaaiadpdoaaaaab"
}
...
Float 160 [_V_speed]
Vector 176 [_Illumin_Color]
Float 192 [_Illumin]
Vector 208 [_Mask_ST]
Float 224 [_U_speed]
Float 228 [_UV_Change]
ConstBuffer "UnityPerCamera" 128
Vector 0 [_Time]
BindCB  "$Globals" 0
BindCB  "UnityPerCamera" 1
"ps_4_0
eefiecedhflpekbcgofickjhehpfofjmgifjocoeabaaaaaapmaeaaaaadaaaaaa
cmaaaaaabeabaaaaeiabaaaaejfdeheooaaaaaaaaiaaaaaaaiaaaaaamiaaaaaa
aaaaaaaaabaaaaaaadaaaaaaaaaaaaaaapaaaaaaneaaaaaaaaaaaaaaaaaaaaaa
...

...
aagabaaaaaaaaaaadiaaaaahicaabaaaaaaaaaaadkaabaaaacaaaaaaabeaaaaa
...
BindCB  "UnityLighting" 1
"ps_4_0

...
BindCB  "UnityLighting" 1
"ps_4_0
eefiecedjapbdnbojmonkkkcofabiinpbdlghkagabaaaaaaeaadaaaaadaaaaaa
...
eaaaaaaaiiaaaaaafjaaaaaeegiocaaaaaaaaaaaagaaaaaafjaaaaaeegiocaaa
...
BindCB  "UnityLighting" 1
"ps_4_0

...
BindCB  "UnityLighting" 1
"ps_4_0

...
BindCB  "UnityLighting" 1
"ps_4_0
eefiecedhnnjjandalkgefdknnlddibdfepikaclabaaaaaamaadaaaaadaaaaaa
cmaaaaaapmaaaaaadaabaaaaejfdeheomiaaaaaaahaaaaaaaiaaaaaalaaaaaaa
aaaaaaaaabaaaaaaadaaaaaaaaaaaaaaapaaaaaalmaaaaaaaaaaaaaaaaaaaaaa
...
BindCB  "UnityShadows" 2
"ps_4_0

...
BindCB  "UnityShadows" 2
"ps_4_0

...
BindCB  "UnityLighting" 1
"ps_4_0

...
Vector 208 [_Diffuse_ST]
ConstBuffer "UnityLighting" 720
Vector 0 [_WorldSpaceLightPos0]
BindCB  "$Globals" 0
BindCB  "UnityLighting" 1
"ps_4_0
eefiecedbfoimgbncogiaofdoockiknpknbbplplabaaaaaafmaeaaaaadaaaaaa
cmaaaaaabeabaaaaeiabaaaaejfdeheooaaaaaaaaiaaaaaaaiaaaaaamiaaaaaa
aaaaaaaaabaaaaaaadaaaaaaaaaaaaaaapaaaaaaneaaaaaaaaaaaaaaaaaaaaaa
...
hcaabaaaaaaaaaaajgahbaaaaaaaaaaaagaabaaaaaaaaaaadcaaaaaldcaabaaa
abaaaaaaegbabaaaabaaaaaaegiacaaaaaaaaaaaanaaaaaaogikcaaaaaaaaaaa
anaaaaaaefaaaaajpcaabaaaabaaaaaaegaabaaaabaaaaaaeghobaaaacaaaaaa
...
BindCB  "UnityShadows" 2
"ps_4_0

...
BindCB  "UnityShadows" 2
"ps_4_0

...
BindCB  "UnityShadows" 2
"ps_4_0

...
abaaaaaaegbabaaaabaaaaaaegiacaaaaaaaaaaaanaaaaaaogikcaaaaaaaaaaa
anaaaaaaefaaaaajpcaabaaaabaaaaaaegaabaaaabaaaaaaeghobaaaadaaaaaa
...
BindCB  "UnityShadows" 2
"ps_4_0

...
BindCB  "UnityShadows" 2
"ps_4_0

...

abaaaaaadgaaaaaficcabaaaaaaaaaaaabeaaaaaaaaaaaaadoaaaaab"
}
SubProgram "opengl " {
...
BindCB  "UnityShadows" 2
"ps_4_0

