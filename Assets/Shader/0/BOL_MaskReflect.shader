ДжShader "BOL/Scene/BOL_MaskReflect" {
Properties {
 ...
 _AtmoColor ("Atmo Color", Color) = (0.5,0.5,0.5,1)
...
ADD R3.x, -R2.w, R0.w;
MAD R4.x, R0.w, R3, R2.w;
MUL R1.xyz, R2, R1;
MOV R3, c[9];
DP4 R3.x, R3, c[2];
ADD R2.w, R0.z, -R4.x;
ADD R1.w, -R1, c[4];
MAD R2.w, R0.z, R2, R4.x;
MAD R1.w, R0, R1, c[0];
MUL R2.xyz, R1, R0.y;
RCP R3.x, R3.x;
MAD R2.xyz, R2, R3.x, -R2.w;
SGE R3.xyz, R0.yzww, c[10].x;
MAD R2.xyz, R0.y, R2, R2.w;
ADD R0.w, -R1, c[3];
MAD R0.w, R0.z, R0, R1;
ADD R0.z, -R0.w, c[2].w;
MOV R2.w, c[5].x;
ADD R2.w, -R2, c[8].x;
MAD R3.z, R3, R2.w, c[5].x;
ADD R2.w, -R3.z, c[7].x;
MAD R2.w, R3.y, R2, R3.z;
ADD R1.w, -R2, c[6].x;
MAD R2.w, R3.x, R1, R2;
TXP R3, fragment.texcoord[1], texture[0], 2D;
MAD R0.y, R0, R0.z, R0.w;
MAD R0.z, R2.w, R2.w, c[10].y;
MUL R0.y, R0.z, R0;
MUL R2.xyz, R0.y, R2;
...
LG2 R3.y, R3.y;
LG2 R3.z, R3.z;
ADD R3.xyz, -R3, fragment.texcoord[5];
MAD R1.xyz, R3, R1, R0.yzww;
DP3 R0.y, fragment.texcoord[2], R4;
DP3 R0.z, R4, fragment.texcoord[3];
...
DP3 R3.w, R0.yzww, R4;
MUL R0.yzw, R0, R3.w;
MAD R4.xyz, -R0.yzww, c[10].z, R4;
MUL R4.w, R2, c[11].y;
MOV R3.w, -R1;
MUL R0.w, R0.x, c[1];
TXB R4.xyz, R4, texture[4], CUBE;
MUL R0.xyz, R2, R4;
MUL R2.xyz, R0.w, c[1];
MAD R0.xyz, R2, c[10].w, R0;
ADD result.color.xyz, R1, R0;
DP4 result.color.w, R3, c[9];
END
...
mad r1.w, r0.z, r1, r2
rcp r2.w, r3.x
add r3.xyz, r0.yzww, c9.x
mul r2.xyz, r1, r0.y
mad r2.xyz, r2, r2.w, -r1.w
mad r2.xyz, r0.y, r2, r1.w
mov_pp r1.w, c8.x
cmp r3.xyz, r3, c9.y, c9.z
add_pp r2.w, -c5.x, r1
mad_pp r3.z, r3, r2.w, c5.x
mov_pp r3.w, c4
add_pp r1.w, -c0, r3
mad_pp r1.w, r0, r1, c0
add_pp r2.w, -r3.z, c7.x
add_pp r0.w, -r1, c3
mad_pp r0.w, r0.z, r0, r1
mad_pp r2.w, r3.y, r2, r3.z
add_pp r1.w, -r2, c6.x
mad_pp r2.w, r3.x, r1, r2
texldp r3, v1, s0
add_pp r0.z, -r0.w, c2.w
mad_pp r0.y, r0, r0.z, r0.w
mad r0.z, r2.w, r2.w, c9.w
mul r0.y, r0.z, r0
mul r2.xyz, r0.y, r2
texld r0.yw, v0.zwzw, s3
mad_pp r4.xy, r0.wyzw, c11.x, c11.y
...
ADD R4.x, R2.z, -R3.w;
ADD R1.w, -R1, c[4];
MAD R0.y, R2.z, R4.x, R3.w;
MAD R1.w, R2, R1, c[0];
MUL R1.xyz, R3, R2.y;
RCP R0.x, R0.x;
MAD R1.xyz, R1, R0.x, -R0.y;
MOV R0.x, c[5];
MAD R1.xyz, R2.y, R1, R0.y;
ADD R0.w, -R0.x, c[8].x;
SGE R0.xyz, R2.yzww, c[10].y;
MAD R0.z, R0, R0.w, c[5].x;
ADD R0.w, -R0.z, c[7].x;
MAD R0.y, R0, R0.w, R0.z;
ADD R2.w, -R1, c[3];
MAD R0.w, R2.z, R2, R1;
ADD R0.z, -R0.y, c[6].x;
MAD R3.w, R0.x, R0.z, R0.y;
ADD R1.w, -R0, c[2];
MAD R0.y, R2, R1.w, R0.w;
MAD R0.x, R3.w, R3.w, c[10].z;
MUL R0.x, R0, R0.y;
MUL R0.xyz, R0.x, R1;
TXP R1, fragment.texcoord[1], texture[0], 2D;
MUL R4.xyz, R0, c[10].w;
...
MAD R2.yzw, R0.xxyz, c[10].x, -R6.xxyz;
DP4 R0.x, fragment.texcoord[6], fragment.texcoord[6];
RSQ R0.z, R0.x;
RCP R0.z, R0.z;
MAD_SAT R0.z, R0, c[9], c[9].w;
MAD R6.xyz, R0.z, R2.yzww, R6;
TEX R0.yw, fragment.texcoord[0].zwzw, texture[5], 2D;
MOV R0.x, c[12].y;
MAD R0.xy, R0.wyzw, c[10].w, -R0.x;
MUL R0.zw, R0.xyxy, R0.xyxy;
...
MAD R3.xyz, R1, R3, R5;
MOV R1.w, -R1;
DP3 R5.x, fragment.texcoord[2], R0;
DP3 R5.y, R0, fragment.texcoord[3];
DP3 R5.z, R0, fragment.texcoord[4];
...
MAD R0.xyz, -R5, c[10].w, R0;
TXB R0.xyz, R0, texture[6], CUBE;
MUL R0.w, R2.x, c[1];
MUL R2.xyz, R4, R0;
MUL R0.xyz, R0.w, c[1];
MAD R0.xyz, R0, c[12].x, R2;
ADD result.color.xyz, R3, R0;
DP4 result.color.w, R1, c[11];
END
...
texld r6, v0, s4
add_pp r0.xyz, -c0, r0
mad_pp r0.xyz, r6.w, r0, c0
add_pp r1.xyz, -r0, c3
mad_pp r0.xyz, r6.z, r1, r0
add_pp r1.xyz, -r0, c2
mad_pp r1.xyz, r6.y, r1, r0
texld r0, v0, s3
mul r3.xyz, r0, r1
add r0.x, -r0.w, r6.w
mad r1.w, r6, r0.x, r0
...
dp4_pp r0.x, c12, r0
add r2.x, r6.z, -r1.w
mad r0.w, r6.z, r2.x, r1
mov_pp r1.w, c8.x
mul r1.xyz, r3, r6.y
rcp r0.x, r0.x
mad r0.xyz, r1, r0.x, -r0.w
mad r0.xyz, r6.y, r0, r0.w
add r1.xyz, r6.yzww, c10.y
mov_pp r0.w, c4
cmp r1.xyz, r1, c10.z, c10.w
add_pp r2.x, -c0.w, r0.w
add_pp r1.w, -c5.x, r1
mad_pp r0.w, r1.z, r1, c5.x
mad_pp r1.w, r6, r2.x, c0
add_pp r1.z, -r0.w, c7.x
mad_pp r0.w, r1.y, r1.z, r0
add_pp r2.x, -r1.w, c3.w
mad_pp r1.z, r6, r2.x, r1.w
texldp r2, v1, s0
add_pp r1.y, -r0.w, c6.x
mad_pp r3.w, r1.x, r1.y, r0
add_pp r1.w, -r1.z, c2
mad_pp r1.x, r6.y, r1.w, r1.z
mad r0.w, r3, r3, c11.x
mul r0.w, r0, r1.x
mul r0.xyz, r0.w, r0
mul r4.xyz, r0, c11.y
log_pp r2.w, r2.w
...
mad_pp r6.yz, r6.xwyw, c11.y, c11.z
mul_pp r1.zw, r6.xyyz, r6.xyyz
...
mul r5.xyz, -r2.w, r4
mad r1.xyz, r0, r3, r5
dp3_pp r2.x, v2, r6.yzww
dp3_pp r2.y, r6.yzww, v3
dp3_pp r2.z, r6.yzww, v4
mov r3.x, v2.w
mov r3.z, v4.w
mov r3.y, v3.w
dp3 r0.w, r2, r3
mul r2.xyz, r2, r0.w
mad r3.xyz, -r2, c11.y, r3
mul r3.w, r1, c10.x
texldb r2.xyz, r3, s6
mul r0.w, r6.x, c1
mul r3.xyz, r4, r2
...
MAD R0.w, R3, R3, c[13].x;
MUL R0.w, R0, R1.x;
MUL R1.xyz, R0.w, R0;
MUL R4.xyz, R1, c[13].y;
TEX R0, fragment.texcoord[5], texture[2], 2D;
DP3_SAT R1.z, R5, c[9];
...
MOV R1.w, c[10];
MAD R5.xy, R2.wyzw, c[13].y, -R1.w;
MUL R2.zw, R5.xyxy, R5.xyxy;
ADD_SAT R1.w, R2.z, R2;
ADD R2.y, -R1.w, c[10].w;
RSQ R2.y, R2.y;
RCP R5.z, R2.y;
MUL R0.xyz, R0.w, R0;
DP3 R1.x, R1, c[9].w;
...
MUL R0.xyz, R0, R4.w;
MUL R0.w, R0, c[9];
MAD R0.xyz, -R0, c[13].y, R5;
TXB R0.xyz, R0, texture[6], CUBE;
MUL R0.w, R2.x, c[1];
MUL R4.xyz, R4, R0;
MUL R0.xyz, R0.w, c[1];
MAD R0.xyz, R0, c[13].z, R4;
MAD R2.xyz, R1, R3, R2.yzww;
ADD result.color.xyz, R2, R0;
DP4 result.color.w, R1, c[12];
END
...
MAD R1.w, R3.x, R1, R2;
MAD R0.y, R0, R0.z, R0.w;
MAD R0.z, R1.w, R1.w, c[10].y;
MUL R0.z, R0, R0.y;
MUL R2.xyz, R0.z, R2;
ADD R1.w, -R1, c[11].x;
MUL R3.xyz, R2, c[10].z;
TEX R0.yw, fragment.texcoord[0].zwzw, texture[3], 2D;
MOV R2.w, c[11].x;
MAD R4.xy, R0.wyzw, c[10].z, -R2.w;
MUL R0.zw, R4.xyxy, R4.xyxy;
TXP R2, fragment.texcoord[1], texture[0], 2D;
ADD_SAT R0.y, R0.z, R0.w;
ADD R3.w, -R0.y, c[11].x;
RSQ R3.w, R3.w;
...
cmp r3.xyz, r3, c9.y, c9.z
add_pp r1.w, -c5.x, r1
mad_pp r3.z, r3, r1.w, c5.x
mov_pp r2.w, c4
add_pp r1.w, -c0, r2
mad_pp r1.w, r0, r1, c0
add_pp r2.w, -r3.z, c7.x
mad_pp r3.y, r3, r2.w, r3.z
add_pp r0.w, -r1, c3
mad_pp r0.w, r0.z, r0, r1
add_pp r2.w, -r3.y, c6.x
mad_pp r1.w, r3.x, r2, r3.y
mad r2.w, r1, r1, c9
add_pp r0.z, -r0.w, c2.w
mad_pp r0.z, r0.y, r0, r0.w
texld r0.yw, v0.zwzw, s3
mul r0.z, r2.w, r0
mul r2.xyz, r0.z, r2
mad_pp r4.xy, r0.wyzw, c11.x, c11.y
...
TEMP R6;
MOV R2, c[0];
TEX R6, fragment.texcoord[5], texture[1], 2D;
...
ADD R3.x, -R1.w, R0.w;
MAD R4.x, R0.w, R3, R1.w;
MUL R2.xyz, R1, R2;
MOV R3, c[11];
DP4 R3.x, R3, c[2];
ADD R1.w, R0.z, -R4.x;
MAD R1.w, R0.z, R1, R4.x;
MUL R6.xyz, R6.w, R6;
MUL R1.xyz, R2, R0.y;
RCP R3.x, R3.x;
MAD R1.xyz, R1, R3.x, -R1.w;
MAD R1.xyz, R0.y, R1, R1.w;
ADD R1.w, -R2, c[4];
MOV R3.x, c[5];
ADD R2.w, -R3.x, c[8].x;
SGE R3.xyz, R0.yzww, c[10].y;
MAD R3.z, R3, R2.w, c[5].x;
MAD R1.w, R0, R1, c[0];
ADD R2.w, -R3.z, c[7].x;
ADD R0.w, -R1, c[3];
...
MAD R2.w, R3.x, R1, R2;
MAD R0.y, R0, R0.z, R0.w;
MAD R0.z, R2.w, R2.w, c[10];
MUL R0.y, R0.z, R0;
MUL R1.xyz, R0.y, R1;
MUL R3.xyz, R1, c[10].w;
TXP R1, fragment.texcoord[1], texture[0], 2D;
MUL R5.xyz, R5, c[10].x;
MAD R0.yzw, R6.xxyz, c[10].x, -R5.xxyz;
MUL R4.xyz, R1.w, R3;
MOV R3.w, c[12].y;
TEX R6.yw, fragment.texcoord[0].zwzw, texture[5], 2D;
MAD R6.xy, R6.wyzw, c[10].w, -R3.w;
DP4 R3.w, fragment.texcoord[6], fragment.texcoord[6];
RSQ R4.w, R3.w;
MUL R6.zw, R6.xyxy, R6.xyxy;
ADD_SAT R3.w, R6.z, R6;
RCP R4.w, R4.w;
MAD_SAT R4.w, R4, c[9].z, c[9];
MAD R5.xyz, R4.w, R0.yzww, R5;
ADD R1.xyz, R1, R5;
MAD R2.xyz, R1, R2, R4;
ADD R3.w, -R3, c[12].y;
RSQ R0.y, R3.w;
RCP R6.z, R0.y;
ADD R0.y, -R2.w, c[12];
DP3 R5.x, fragment.texcoord[2], R6;
DP3 R5.y, R6, fragment.texcoord[3];
DP3 R5.z, R6, fragment.texcoord[4];
MOV R4.x, fragment.texcoord[2].w;
MOV R4.z, fragment.texcoord[4].w;
MOV R4.y, fragment.texcoord[3].w;
DP3 R0.z, R5, R4;
MUL R5.xyz, R5, R0.z;
MUL R4.w, R0.y, c[10].x;
MAD R4.xyz, -R5, c[10].w, R4;
MUL R0.w, R0.x, c[1];
TXB R4.xyz, R4, texture[6], CUBE;
MUL R0.xyz, R3, R4;
MUL R3.xyz, R0.w, c[1];
MAD R0.xyz, R3, c[12].x, R0;
ADD result.color.xyz, R2, R0;
DP4 result.color.w, R1, c[11];
END
...
dp4_pp r0.x, c12, r0
add r2.x, r3.z, -r1.w
mad r0.w, r3.z, r2.x, r1
mov_pp r1.w, c8.x
mul r1.xyz, r4, r3.y
rcp r0.x, r0.x
mad r0.xyz, r1, r0.x, -r0.w
mad r0.xyz, r3.y, r0, r0.w
add r1.xyz, r3.yzww, c10.y
mov_pp r0.w, c4
cmp r1.xyz, r1, c10.z, c10.w
add_pp r2.x, -c0.w, r0.w
add_pp r1.w, -c5.x, r1
mad_pp r0.w, r1.z, r1, c5.x
mad_pp r1.w, r3, r2.x, c0
add_pp r1.z, -r0.w, c7.x
mad_pp r0.w, r1.y, r1.z, r0
add_pp r2.x, -r1.w, c3.w
mad_pp r1.z, r3, r2.x, r1.w
add_pp r1.y, -r0.w, c6.x
mad_pp r4.w, r1.x, r1.y, r0
add_pp r1.w, -r1.z, c2
texldp r2, v1, s0
mad_pp r1.x, r3.y, r1.w, r1.z
mad r0.w, r4, r4, c11.x
mul r0.w, r0, r1.x
mul r0.xyz, r0.w, r0
mul r5.xyz, r0, c11.y
texld r0, v5, s2
mul_pp r0.xyz, r0.w, r0
mul_pp r3.yzw, r0.xxyz, c10.x
texld r1, v5, s1
mul_pp r1.xyz, r1.w, r1
...
rsq_pp r0.z, r0.z
rcp_pp r0.z, r0.z
mad_pp r1.xyz, r1, c10.x, -r3.yzww
mad_sat r0.w, r0, c9.z, c9
mad_pp r1.xyz, r0.w, r1, r3.yzww
add_pp r1.xyz, r2, r1
mul r6.xyz, r2.w, r5
mad r2.xyz, r1, r4, r6
dp3_pp r4.x, v2, r0
...
add r1.w, -r4, c10.z
mul r0.w, r1, c10.x
mad r0.xyz, -r4, c11.y, r0
texldb r0.xyz, r0, s6
mul r0.w, r3.x, c1
mul r3.xyz, r5, r0
mul r0.xyz, r0.w, c1
mad r0.xyz, r0, c11.w, r3
mov_pp r1.w, r2
add oC0.xyz, r2, r0
dp4_pp oC0.w, r1, c12
"
