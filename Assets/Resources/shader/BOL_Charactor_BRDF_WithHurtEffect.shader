•±Shader "Custom/BOL_Character_BRDF_WithHurtEffect" {
Properties {
 ...
 _Attack_Para ("Attack Para", Vector) = (1,0.2,0.2,0)
 _Attack_Color ("Attack Color", Color) = (1,1,1,1)
 _EmissUvAnimTex ("Emissve Anim Tex", 2D) = "black" {}
}
SubShader { 
 LOD 400
...
Float 7 [_BRDF_PARA]
Vector 8 [_Attack_Para]
Vector 9 [_Attack_Color]
...
SetTexture 6 [_EmissUvAnimTex] 2D 6
"3.0-!!ARBfp1.0
OPTION ARB_precision_hint_fastest;
PARAM c[12] = { program.local[0..9],
		{ 0.12298584, 0.80000001, 0.30000001, 0.5 },
		{ 16, 2, 1 } };
TEMP R0;
TEMP R1;
TEMP R2;
...
MOV R1.xyz, c[2];
ADD R2.xyz, -R1, c[5];
MAD R2.xyz, R0.z, R2, c[2];
ADD R3.xyz, -R2, c[4];
MAD R2.xyz, R0.y, R3, R2;
TEX R3.yw, fragment.texcoord[0].zwzw, texture[3], 2D;
MAD R4.xy, R3.wyzw, c[11].y, -c[11].z;
DP3 R1.x, fragment.texcoord[7], fragment.texcoord[7];
RSQ R0.z, R1.x;
MUL R1.xyz, R0.z, fragment.texcoord[7];
DP3 R0.y, fragment.texcoord[6], R1;
MUL R3.x, R0.y, c[10].y;
DP3 R0.y, fragment.texcoord[6], c[1];
MAD R3.y, R0, c[10].z, c[10].w;
MUL R4.zw, R4.xyxy, R4.xyxy;
ADD_SAT R0.y, R4.z, R4.w;
...
DP3 R3.w, R0.yzww, R4;
MUL R0.yzw, R0, R3.w;
MAD R4.xyz, -R0.yzww, c[11].y, R4;
TEX R4.xyz, R4, texture[4], CUBE;
MUL R0.w, R0.x, c[3];
MUL R0.xyz, R2.w, R4;
MUL R4.xyz, R0.w, c[3];
MAD R0.xyz, R4, c[11].x, R0;
MUL R3.xyz, R3, -R1.w;
LG2 R1.x, R1.x;
LG2 R1.z, R1.z;
LG2 R1.y, R1.y;
...
MAD R0.xy, R1.yzzw, c[0].y, R0.x;
MUL R2.xyz, R2, R0.z;
TEX R0.y, R0, texture[6], 2D;
MAD R1.xyz, R1.x, c[9], R2;
ADD result.color.xyz, R1, R0.y;
...
dcl_2d s5
dcl_2d s6
def c10, 0.80000001, 0.30000001, 0.50000000, 2.00000000
def c11, 2.00000000, -1.00000000, 16.00000000, 1.00000000
...
mad r4.y, r0, c10, c10.z
mad_pp r0.yz, r3.xwyw, c11.x, c11.y
texld r3.xyz, r4, s5
mul_pp r4.xy, r0.yzzw, r0.yzzw
mul r3.xyz, r3, c7.x
mad r1.xyz, r2, r1, r3
texldp r3, v1, s0
...
rsq_pp r0.w, r2.x
rcp_pp r0.w, r0.w
dp3_pp r4.x, v2, r0.yzww
dp3_pp r4.y, r0.yzww, v3
dp3_pp r4.z, r0.yzww, v4
mov r0.y, v2.w
mov r0.w, v4
mov r0.z, v3.w
dp3 r4.w, r4, r0.yzww
mul r4.xyz, r4, r4.w
mad r4.xyz, -r4, c10.w, r0.yzww
mul r0.w, r0.x, c3
mul r2.xyz, r1, r1.w
log_pp r2.w, r3.w
mul r2.xyz, r2, -r2.w
...
texld r0.x, v0, s6
mov r0.y, c0
mad r0.xy, c8.yzzw, r0.y, r0.x
texld r0.y, r0, s6
mad r1.xyz, c8.x, r2, r1
add_pp oC0.xyz, r1, r0.y
mov_pp oC0.w, c12.x
"
}
SubProgram "opengl " {
Keywords { "LIGHTMAP_ON" "DIRLIGHTMAP_OFF" "HDR_LIGHT_PREPASS_OFF" }
Vector 0 [_Time]
Vector 1 [_Attack_Para]
Vector 2 [_Attack_Color]
SetTexture 4 [_EmissUvAnimTex] 2D 4
"3.0-!!ARBfp1.0
OPTION ARB_precision_hint_fastest;
PARAM c[5] = { program.local[0..3],
		{ 0.12298584 } };
...
MAD R0.xy, R0.ywzw, c[0].y, R0.x;
TEX R0.y, R0, texture[4], 2D;
MUL R0.xzw, R0.z, c[2].xyyz;
ADD result.color.xyz, R0.xzww, R0.y;
MOV result.color.w, c[4].x;
END
...
"ps_3_0
dcl_2d s4
def c3, 0.12298584, 0, 0, 0
dcl_texcoord0 v0.xy
mov r1.xyz, c2
texld r0.x, v0, s4
mov r0.y, c0
mad r0.xy, c1.yzzw, r0.y, r0.x
texld r0.y, r0, s4
mul r1.xyz, c1.x, r1
add_pp oC0.xyz, r1, r0.y
mov_pp oC0.w, c3.x
...
ADD R0.xyz, -R0, c[5];
MAD R0.xyz, R3.z, R0, c[2];
ADD R1.xyz, -R0, c[4];
MAD R2.xyz, R3.y, R1, R0;
DP3 R0.w, fragment.texcoord[7], fragment.texcoord[7];
RSQ R0.x, R0.w;
MUL R0.xyz, R0.x, fragment.texcoord[7];
DP3 R0.z, fragment.texcoord[6], R0;
TEX R4.yw, fragment.texcoord[0].zwzw, texture[3], 2D;
MAD R0.xy, R4.wyzw, c[11].y, -c[11].z;
MUL R4.xy, R0, R0;
ADD_SAT R1.w, R4.x, R4.y;
DP3 R0.w, fragment.texcoord[6], c[1];
MUL R0.z, R0, c[10].y;
MAD R0.w, R0, c[10].z, c[10];
TEX R4.xyz, R0.zwzw, texture[5], 2D;
ADD R1.w, -R1, c[11].z;
RSQ R0.z, R1.w;
RCP R0.z, R0.z;
MUL R4.xyz, R4, c[7].x;
...
ADD R0.z, R0.y, -c[8].x;
TEX R0.x, fragment.texcoord[0], texture[6], 2D;
MAD R0.xy, R2.yzzw, c[0].y, R0.x;
MUL R1.xyz, R1, R0.z;
TEX R0.y, R0, texture[6], 2D;
MAD R1.xyz, R2.x, c[9], R1;
ADD result.color.xyz, R1, R0.y;
MOV result.color.w, c[10].x;
END
...
Vector 1 [_Attack_Para]
Vector 2 [_Attack_Color]
SetTexture 3 [_EmissUvAnimTex] 2D 3
"3.0-!!ARBfp1.0
OPTION ARB_precision_hint_fastest;
PARAM c[5] = { program.local[0..3],
		{ 0.12298584 } };
