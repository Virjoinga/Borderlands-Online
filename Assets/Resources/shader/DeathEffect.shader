...
BindCB  "$Globals" 0
"ps_4_0
eefiecedehlmgafiolehbfelpdoomkefohffkgffabaaaaaamaabaaaaadaaaaaa
...
BindCB  "$Globals" 0
"ps_4_0_level_9_1
eefieceddplhldimbmlnijnpjjoigoobenhlffdfabaaaaaaieacaaaaaeaaaaaa
...
hdgijbdnaaaaaaaabpaaaaacaaaaaaiaaaaaaplabpaaaaacaaaaaajaaaaiapka
ecaaaaadaaaacpiaaaaaoelaaaaioekaaiaaaaadabaaciiaaaaaoeiaabaaoeka
bcaaaaaeacaachiaaaaaaakaaaaaoeiaabaappiaabaaaaacacaaciiaaaaappia
...
aaaaaaaaegacbaaaaaaaaaaaagaabaiaebaaaaaaabaaaaaadcaaaaakhccabaaa
aaaaaaaaagiacaaaaaaaaaaaabaaaaaaegacbaaaaaaaaaaaagaabaaaabaaaaaa
...
eeaaaaaaaaaaaaaaaaaaaaaaadaaaaaaabaaaaaaapadaaaafdfgfpfagphdgjhe
...
Float 0 [_LumOffset]
Float 1 [_AccumOrig]
Float 2 [_LumScenePara]
Float 3 [_LumFpsPara]
SetTexture 0 [_MainTex] 2D 0
"!!ARBfp1.0
OPTION ARB_precision_hint_fastest;
PARAM c[6] = { program.local[0..3],
		{ 1, 0, 0.12200928, 0.12402344 },
		{ 0.2199707, 0.70703125, 0.070983887 } };
TEMP R0;
TEMP R1;
TEX R0, fragment.texcoord[0], texture[0], 2D;
...
MUL R0.y, R0, c[3].x;
MUL R0.x, R0, c[0];
CMP result.color.xyz, -R0.w, R0.x, R0.y;
...
"ps_2_0
dcl_2d s0
def c4, 0.12200928, 0.00000000, 1.00000000, -0.12402344
def c5, 0.21997070, 0.70703125, 0.07098389, 0
dcl t0.xy
texld r2, t0, s0
add_pp r1.x, r2.w, c4.w
add_pp r0.x, -r2.w, c4
cmp_pp r1.x, r1, c4.y, c4.z
cmp_pp r0.x, r0, c4.y, c4.z
mul_pp r0.x, r0, r1
dp3_pp r1.x, r2, c5
mov r2.x, c3
mul r1.x, r1, c2
...
Float 20 [_LumOffset]
Float 28 [_AccumOrig]
Float 32 [_LumScenePara]
Float 36 [_LumFpsPara]
BindCB  "$Globals" 0
"ps_4_0

...
BindCB  "$Globals" 0
"ps_4_0_level_9_1

...

...
SetTexture 0 [_MainTex] 2D 0
"ps_4_0

...
SetTexture 0 [_MainTex] 2D 0
"ps_4_0_level_9_1
eefiecedonceeaojlfpaenkppcglhpkdkbpmkgefabaaaaaapeabaaaaaeaaaaaa
...
SubProgram "d3d11 " {
"ps_4_0

...
SubProgram "d3d11_9x " {
"ps_4_0_level_9_1
eefiecedlkjbomccagipnkjahlghkkgapndledmlabaaaaaagaabaaaaaeaaaaaa
